...
const images = [
  ...
  {
    file: 'assets/highlight-founders.jpg',
    prompt: 'Filipino startup founders networking meetup in a modern coworking space, young diverse Filipino entrepreneurs smiling and collaborating, warm ambient lighting, candid professional photography, vibrant energy, photorealistic'
  },
  {
  ...
  {
    file: 'assets/highlight-bayanihan.jpg',
    prompt: 'Filipino community bayanihan spirit, young Filipino volunteers and professionals gathered outdoors for a community initiative, smiling diverse group, golden hour warm lighting, wide shot, teamwork and unity, photorealistic'
  }
];
...
await Promise.all(images.map(generateOne));
console.log('\nAll community images done!');
